...
export const updateTagValidation = [
  ...
  body("name")
    .optional()
    .isString().withMessage("El nombre del tag debe ser una cadena de texto.")
    .isLength({ min: 2, max: 30 }).withMessage("El nombre del tag debe tener entre 2 y 30 caracteres.")
    .custom((value) => {
      if (!/^\S+$/.test(value)) {
        throw new Error("El tag no puede contener espacios.");
      }
